...
if(WIN32)
    ...
    set(CONFIGURE_COMMAND ${CORAH_EXTERNAL_BUILD_DIR}/qt5/src/qt5/configure.bat)
    ...
    set(CONFIGURE_COMMAND ${CORAH_EXTERNAL_BUILD_DIR}/qt5/src/qt5/configure)
...
ExternalProject_Add(qt5
        ...
        URL ${URL}
        URL_HASH ${URL_HASH}
        CONFIGURE_COMMAND ${CONFIGURE_COMMAND} -prefix ${CORAH_EXTERNAL_INSTALL_DIR}; ${OPTIONS}
